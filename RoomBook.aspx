<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoomBook.aspx.cs" Inherits="WebApplicationDBMS.RoomBook" %>
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
         ...
         <div class="row">
            <asp:Button ID="btnbook" runat="server" Text="Book" OnClick="btnbook_Click" style="background-color: black; color: #fff; border: 1px solid #007bff;"/>
        </div>
    </div>
    </form>
</body>
